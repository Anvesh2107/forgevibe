...
import { Bell, Trophy, Zap, PlusCircle, MessageSquare, Shield, User, ChevronDown, LogOut } from "lucide-react";
      ...
      <footer className="border-t border-border mt-16 py-8">
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between text-sm text-muted-foreground">
          ...
          <div className="flex items-center gap-1 text-xs">
            ...
            <span className="font-semibold text-primary">Perplexity Computer</span>
          </div>
        </div>
      </footer>
    </div>
